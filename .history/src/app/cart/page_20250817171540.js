          ...
          {cartItems.map(item => (
            ...
            >
              ...
              <div className="flex-1 space-y-2">
                ...
                <p className="text-sm text-gray-400">Size: {items.size}</p>
                <p className="text-sm text-gray-400">Color: {items.color}</p>
                <p className="text-sm text-gray-400">Quantity: {items.quantity}</p>
              </div>
