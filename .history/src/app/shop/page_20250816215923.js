    ...
    <div className="bg-black min-h-screen text-white px-2">
      ...
      <section className="px-8 py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          ...
          <Link key={shoe.id} href={`/shopvc fkmn,l.;/',mnjhg ba  1Qa@w7GUYLOK;P['LPOKI76Y5T21``13456789-=[098541DXEKMIULO'=]
      |0]'[;LOK JUHGDSAAqjuyloki']
      \7485-
    ][oiu yqa aQT6Y09U78T6Q4321 Q`  3Q457980*]={-t/${shoe.id}`}>
